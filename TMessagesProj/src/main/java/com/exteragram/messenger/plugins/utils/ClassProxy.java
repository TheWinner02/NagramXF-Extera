...
public class ClassProxy {
    ...
    private static final String PYTHON_PEER_FIELD_NAME = Deobfuscator$exteraGramDev$TMessagesProj.getString(-52611071100463L);
    ...
    public static void runPythonRunnable(PyObject pyObject) {
        if (pyObject == null) {
            AppUtils.log(Deobfuscator$exteraGramDev$TMessagesProj.getString(-36994570012207L));
            return;
        }
        try {
            pyObject.call(EMPTY_ARGS);
        } catch (Exception e) {
            AppUtils.log(Deobfuscator$exteraGramDev$TMessagesProj.getString(-35525691196975L), e);
        }
    }

    public static Class<?> createProxyClass(Class<?> cls, Utilities.Callback3Return<Object, String, Object[], Object> callback3Return, List<Method> list, List<Constructor<?>> list2) throws Exception {
        return createProxyClassInternal(cls, callback3Return, null, null, list, list2, null, null, null, true);
    }

    public static Class<?> createProxyClass(Class<?> cls, Utilities.Callback3Return<Object, String, Object[], Object> callback3Return, List<Method> list, List<Constructor<?>> list2, String str) throws Exception {
        return createProxyClassInternal(cls, callback3Return, null, null, list, list2, null, null, str, true);
    }

    public static Class<?> createProxyClass(Class<?> cls, Utilities.Callback3Return<Object, String, Object[], Object> callback3Return, List<Method> list, List<Constructor<?>> list2, List<ProxyMethodSpec> list3, List<FieldSpec> list4) throws Exception {
        return createProxyClassInternal(cls, callback3Return, null, null, list, list2, list3, list4, null, false);
    }

    public static Class<?> createProxyClass(Class<?> cls, Utilities.Callback3Return<Object, String, Object[], Object> callback3Return, List<Method> list, List<Constructor<?>> list2, List<ProxyMethodSpec> list3, List<FieldSpec> list4, String str) throws Exception {
        return createProxyClassInternal(cls, callback3Return, null, null, list, list2, list3, list4, str, false);
    }

    public static Class<?> createProxyClass(Class<?> cls, Utilities.Callback3Return<Object, String, Object[], Object> callback3Return, DexMakerHook dexMakerHook, List<Class<?>> list, List<Method> list2, List<Constructor<?>> list3, List<ProxyMethodSpec> list4, List<FieldSpec> list5) throws Exception {
        return createProxyClassInternal(cls, callback3Return, dexMakerHook, list, list2, list3, list4, list5, null, false);
    }

    public static Class<?> createProxyClass(Class<?> cls, Utilities.Callback3Return<Object, String, Object[], Object> callback3Return, DexMakerHook dexMakerHook, List<Class<?>> list, List<Method> list2, List<Constructor<?>> list3, List<ProxyMethodSpec> list4, List<FieldSpec> list5, String str) throws Exception {
    ...
    private static Class<?> createProxyClassInternal(Class<?> cls, Utilities.Callback3Return<Object, String, Object[], Object> callback3Return, DexMakerHook dexMakerHook, List<Class<?>> list, List<Method> list2, List<Constructor<?>> list3, List<ProxyMethodSpec> list4, List<FieldSpec> list5, String str, boolean z) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException {
        ...
        if (simpleName.isEmpty()) {
            simpleName = Deobfuscator$exteraGramDev$TMessagesProj.getString(-35534281131567L);
        }
        String strSanitizeProxyClassSegment = sanitizeProxyClassSegment(str);
        StringBuilder sb = new StringBuilder();
        sb.append(Deobfuscator$exteraGramDev$TMessagesProj.getString(-35645950281263L));
        sb.append(simpleName);
        sb.append(strSanitizeProxyClassSegment != null ? Deobfuscator$exteraGramDev$TMessagesProj.getString(-35199273682479L) + strSanitizeProxyClassSegment : Deobfuscator$exteraGramDev$TMessagesProj.getString(-35207863617071L));
        sb.append(Deobfuscator$exteraGramDev$TMessagesProj.getString(-35203568649775L));
        sb.append(Math.abs(cls.getName().hashCode()));
        sb.append(Deobfuscator$exteraGramDev$TMessagesProj.getString(-35212158584367L));
        sb.append(Math.abs(new Random().nextInt()));
        String string = sb.toString();
        TypeId typeId2 = TypeId.get(Deobfuscator$exteraGramDev$TMessagesProj.getString(-35289467995695L) + string.replace('.', '/') + Deobfuscator$exteraGramDev$TMessagesProj.getString(-35298057930287L));
        TypeId typeId3 = TypeId.get(cls);
        FieldId field = typeId2.getField(TypeId.get(Utilities.Callback3Return.class), Deobfuscator$exteraGramDev$TMessagesProj.getString(-35306647864879L));
        TypeId<?>[] interfaceTypeIds = toInterfaceTypeIds(list);
        ArrayList arrayList = new ArrayList();
        Collections.addAll(arrayList, interfaceTypeIds);
        dexMaker.declare(typeId2, Deobfuscator$exteraGramDev$TMessagesProj.getString(-35366777407023L), 1, typeId3, interfaceTypeIds);
                ...
                if (next != null && next.name != null) {
                    if (next.overrideExisting) {
                        if (next.parameterTypes == null) {
                            ...
                            if (method3 == null) {
                                throw new NoSuchMethodException(Deobfuscator$exteraGramDev$TMessagesProj.getString(-35418317014575L) + next.name);
                            }
        ...
        for (Object entryObj : linkedHashMap2.entrySet()) {
            Map.Entry entry = (Map.Entry) entryObj;
            Method method4 = (Method) entry.getValue();
            generateProxyMethod(dexMaker, typeId2, method4, field, true);
            ...
            if (proxyMethodSpec != null && proxyMethodSpec.isMvel()) {
                ...
                generateMvelMethod(dexMaker, typeId, method4.getName(), method4.getReturnType(), method4.getParameterTypes(), 1, proxyMethodSpec.mvelCode, proxyMethodSpec.argumentNames);
            } else {
                typeId = typeId2;
                linkedHashMap = linkedHashMap3;
                generateProxyMethod(dexMaker, typeId, method4, field, false);
            }
            typeId2 = typeId;
        ...
        while (i < size) {
            ...
            if (proxyMethodSpec2.isMvel()) {
                generateMvelMethod(dexMaker, typeId4, proxyMethodSpec2.name, proxyMethodSpec2.returnType != null ? proxyMethodSpec2.returnType : Void.TYPE, proxyMethodSpec2.parameterTypes != null ? proxyMethodSpec2.parameterTypes : new Class[0], proxyMethodSpec2.modifiers != 0 ? proxyMethodSpec2.modifiers : 1, proxyMethodSpec2.mvelCode, proxyMethodSpec2.argumentNames);
                fieldId = field;
            } else {
                TypeId typeId5 = typeId4;
                FieldId fieldId2 = field;
                generateHandlerMethod(dexMaker, typeId5, proxyMethodSpec2.name, proxyMethodSpec2.returnType != null ? proxyMethodSpec2.returnType : Void.TYPE, proxyMethodSpec2.parameterTypes != null ? proxyMethodSpec2.parameterTypes : new Class[0], proxyMethodSpec2.modifiers != 0 ? proxyMethodSpec2.modifiers : 1, fieldId2);
                typeId4 = typeId5;
                fieldId = fieldId2;
            }
            field = fieldId;
        ...
        if (dexMakerHook != null) {
            dexMakerHook.apply(dexMaker, typeId4, typeId3, arrayList);
        }
        byte[] bArrGenerate = dexMaker.generate();
        ...
        Field declaredField = clsLoadClass.getDeclaredField(Deobfuscator$exteraGramDev$TMessagesProj.getString(-36200001062447L));
    ...
    private static TypeId<?>[] toInterfaceTypeIds(List<Class<?>> list) {
        ...
        for (Class<?> cls : list) {
            if (cls != null) {
                if (!cls.isInterface()) {
                    throw new IllegalArgumentException(Deobfuscator$exteraGramDev$TMessagesProj.getString(-36260130604591L) + cls.getName());
                }
    ...
    private static void generateConstructor(DexMaker dexMaker, TypeId<?> typeId, TypeId<?> typeId2, Constructor<?> constructor, FieldId fieldId) {
        ...
        MethodId method = typeId3.getMethod(typeId4, Deobfuscator$exteraGramDev$TMessagesProj.getString(-35757619430959L), typeId4, typeId4, typeId4);
        ...
        codeDeclare.move((Local) localNewLocal6, (Local) localNewLocal3);
        codeDeclare.sget(fieldId, localNewLocal);
        codeDeclare.loadConstant(localNewLocal2, buildMethodSignature(Deobfuscator$exteraGramDev$TMessagesProj.getString(-35843518776879L), parameterTypes));
        ...
        for (int i4 = 0; i4 < parameterTypes.length; i4++) {
            codeDeclare.move((Local) localArr2[i4], (Local) codeDeclare.getParameter(i4, typeIdArr[i4]));
        }
        ...
        for (int i5 = 0; i5 < parameterTypes.length; i5++) {
            ...
            codeDeclare.invokeStatic(typeId6.getMethod(typeId7, Deobfuscator$exteraGramDev$TMessagesProj.getString(-35834928842287L), parameterTypes[i5].isPrimitive() ? typeIdArr[i5] : typeId7), localArr[i5], localArr2[i5]);
        ...
        for (int i6 = 0; i6 < parameterTypes.length; i6++) {
            ...
            if (parameterTypes[i6].isPrimitive()) {
                codeDeclare.invokeStatic((MethodId) TypeId.get(TypeHelper.class).getMethod(typeIdArr[i6], Deobfuscator$exteraGramDev$TMessagesProj.getString(-35920828188207L) + capitalize(parameterTypes[i6].getName()), TypeId.OBJECT), (Local) localArr2[i6], (Local) localNewLocal9);
            } else {
    ...
    private static void generateProxyMethod(DexMaker dexMaker, TypeId<?> typeId, Method method, FieldId fieldId, boolean z) {
        ...
        String name = z ? Deobfuscator$exteraGramDev$TMessagesProj.getString(-35877878515247L) + method.getName() : method.getName();
        if (z) {
            ...
            codeDeclare.invokeSuper((MethodId) TypeId.get(method.getDeclaringClass()).getMethod(typeId2, method.getName(), typeIdArr), (Local) localNewLocal, local, localArr);
    ...
    private static void generateHandlerMethod(DexMaker dexMaker, TypeId<?> typeId, String str, Class<?> cls, Class<?>[] clsArr, int i, FieldId fieldId) {
        ...
        MethodId method = typeId2.getMethod(typeId3, Deobfuscator$exteraGramDev$TMessagesProj.getString(-35899353351727L), typeId3, typeId3, typeId3);
        ...
        for (int i3 = 0; i3 < clsArr2.length; i3++) {
            localArr[i3] = codeDeclare.newLocal(typeId3);
        }
        ...
        while (i4 < clsArr2.length) {
            ...
            TypeId typeId6 = TypeId.get(TypeHelper.class);
            TypeId<?> typeId7 = TypeId.OBJECT;
            codeDeclare.invokeStatic(typeId6.getMethod(typeId7, Deobfuscator$exteraGramDev$TMessagesProj.getString(-35985252697647L), clsArr2[i4].isPrimitive() ? typeIdArr[i4] : typeId7), localArr[i4], parameter);
        ...
        if (cls.isPrimitive()) {
            codeDeclare.invokeStatic((MethodId) TypeId.get(TypeHelper.class).getMethod(typeId4, Deobfuscator$exteraGramDev$TMessagesProj.getString(-36002432566831L) + capitalize(cls.getName()), typeId3), (Local) localNewLocal, (Local) localNewLocal6);
        } else {
    ...
    private static void generateMvelMethod(DexMaker dexMaker, TypeId<?> typeId, String str, Class<?> cls, Class<?>[] clsArr, int i, String str2, List<String> list) {
        ...
        if (!Modifier.isStatic(i)) {
            Object field = typeId.getField(TypeId.OBJECT, Deobfuscator$exteraGramDev$TMessagesProj.getString(-35959482893871L));
            codeDeclare.cast(localNewLocal, local2);
            codeDeclare.iget((FieldId) field, (Local) localNewLocal2, (Local) local2);
        }
        ...
        while (i4 < clsArr.length) {
            ...
            TypeId<?> typeId7 = TypeId.OBJECT;
            int i5 = i4;
            codeDeclare.invokeStatic(typeId6.getMethod(typeId7, Deobfuscator$exteraGramDev$TMessagesProj.getString(-52039840450095L), clsArr[i4].isPrimitive() ? typeIdArr[i4] : typeId7), localArr[i5], parameter);
            codeDeclare.loadConstant(localNewLocal8, Integer.valueOf(i5));
        ...
        if (list != null && !list.isEmpty()) {
            ...
            for (int i6 = 0; i6 < list.size(); i6++) {
                codeDeclare.loadConstant((Local) localNewLocal11, list.get(i6));
                codeDeclare.loadConstant(localNewLocal8, Integer.valueOf(i6));
        ...
        codeDeclare.invokeStatic(typeId8.getMethod(typeId9, Deobfuscator$exteraGramDev$TMessagesProj.getString(-52125739796015L), typeId9, typeId9, TypeId.STRING, TypeId.get(String[].class), TypeId.get(Object[].class)), localNewLocal3, localNewLocal, localNewLocal2, localNewLocal4, localNewLocal6, localNewLocal5);
        if (typeId2.equals(TypeId.VOID)) {
            codeDeclare.returnVoid();
            return;
        }
        if (cls.isPrimitive()) {
            MethodId method = TypeId.get(TypeHelper.class).getMethod(typeId2, Deobfuscator$exteraGramDev$TMessagesProj.getString(-52203049207343L) + capitalize(cls.getName()), typeId9);
    ...
    private static void generateFieldAccessorMethod(DexMaker dexMaker, TypeId<?> typeId, FieldSpec fieldSpec, FieldMethodSpec fieldMethodSpec) {
        ...
        if (fieldMethodSpec.getter) {
            ...
            if (zIsStatic) {
                codeDeclare.sget((FieldId) field, (Local) localNewLocal);
            } else {
                codeDeclare.iget((FieldId) field, (Local) localNewLocal, (Local) codeDeclare.getThis(typeId));
            }
            codeDeclare.returnValue(localNewLocal);
            return;
        }
        ...
        if (zIsStatic) {
            codeDeclare2.sput((FieldId) field, parameter);
        } else {
            codeDeclare2.iput((FieldId) field, (Local) codeDeclare2.getThis(typeId), parameter);
        }
    ...
    public static Object executeMvelMethod(Object obj, Object obj2, String str, String[] strArr, Object[] objArr) {
        ...
        map.put(Deobfuscator$exteraGramDev$TMessagesProj.getString(-52160099534383L), obj);
        map.put(Deobfuscator$exteraGramDev$TMessagesProj.getString(-52190164305455L), obj2);
        map.put(Deobfuscator$exteraGramDev$TMessagesProj.getString(-51730602804783L), obj2);
        map.put(Deobfuscator$exteraGramDev$TMessagesProj.getString(-51683358164527L), obj2);
        map.put(Deobfuscator$exteraGramDev$TMessagesProj.getString(-51696243066415L), objArr);
        map.put(Deobfuscator$exteraGramDev$TMessagesProj.getString(-51795027314223L), Integer.valueOf(objArr.length));
        for (int i = 0; i < objArr.length; i++) {
            Object obj3 = objArr[i];
            map.put(Deobfuscator$exteraGramDev$TMessagesProj.getString(-51807912216111L) + i, obj3);
            if (strArr != null && i < strArr.length && (str2 = strArr[i]) != null && !str2.isEmpty()) {
                map.put(str2, obj3);
            }
        }
        Object compiledExpr = mvelExpressionCache.computeIfAbsent(str, new Function() {
            @Override
            public final Object apply(Object obj4) {
                return MVEL.compileExpression((String) obj4);
            }
        });
        return MVEL.executeExpression(compiledExpr, map);
    }

    private static String capitalize(String str) {
        if (str.equals(Deobfuscator$exteraGramDev$TMessagesProj.getString(-51756372608559L))) {
            return Deobfuscator$exteraGramDev$TMessagesProj.getString(-51773552477743L);
        }
        if (str.equals(Deobfuscator$exteraGramDev$TMessagesProj.getString(-51859451823663L))) {
            return Deobfuscator$exteraGramDev$TMessagesProj.getString(-51825092085295L);
        }
        if (str.equals(Deobfuscator$exteraGramDev$TMessagesProj.getString(-51923876333103L))) {
            return Deobfuscator$exteraGramDev$TMessagesProj.getString(-51949646136879L);
        }
        if (str.equals(Deobfuscator$exteraGramDev$TMessagesProj.getString(-51906696463919L))) {
            return Deobfuscator$exteraGramDev$TMessagesProj.getString(-52538056656431L);
        }
        if (str.equals(Deobfuscator$exteraGramDev$TMessagesProj.getString(-52568121427503L))) {
            return Deobfuscator$exteraGramDev$TMessagesProj.getString(-52512286852655L);
        }
    ...
    public static final class ProxyMethodSpec extends RecordTag {
        ...
        public final String toString() {
            return "ProxyMethodSpec[" + this.name + "]";
        }

        public ProxyMethodSpec(String str, Class<?> cls, Class<?>[] clsArr, int i, boolean z) {
            this(str, cls, clsArr, i, z, Deobfuscator$exteraGramDev$TMessagesProj.getString(-37011749881391L), null, null);
        }

        public boolean isMvel() {
            return Deobfuscator$exteraGramDev$TMessagesProj.getString(-37033224717871L).equals(this.implementation) && this.mvelCode != null;
        }
    }
    ...
    public static final class FieldMethodSpec extends RecordTag {
        ...
        public final String toString() {
            return "FieldMethodSpec[" + this.name + "]";
        }
    }
