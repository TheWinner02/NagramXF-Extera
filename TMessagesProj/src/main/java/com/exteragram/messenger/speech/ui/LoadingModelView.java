...
public class LoadingModelView extends FrameLayout {
    ...
    public LoadingModelView(Context context) {
        ...
        this.title.setText("Downloading Model...");
        ...
        this.subtitle.setText("Downloading speech recognition model...");
    ...
    public void setProgress(float f) {
        ...
        this.percentsTextView.setText(iCeil == 100 ? "Unzipping model..." : String.format("%s%%", Integer.valueOf(iCeil)), !LocaleController.isRTL);
