...
//        }
    ...
    private void checkSnowflake(Canvas canvas) {
        if (((backgroundView != null && Theme.canStartHolidayAnimation() && LiteMode.isEnabled(LiteMode.FLAG_CHAT_BACKGROUND)) || NaConfig.INSTANCE.getChatDecoration().Int() == 1 || NaConfig.INSTANCE.getForceSnowfall().Bool()) && NaConfig.INSTANCE.getChatDecoration().Int() != 2) {
