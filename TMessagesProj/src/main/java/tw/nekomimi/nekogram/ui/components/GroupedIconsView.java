...
public class GroupedIconsView extends ActionRow {
    ...
    public GroupedIconsView(Context context, ChatActivity chatActivity, MessageObject messageObject,
                            ...
                            boolean allowCopy, boolean allowCopyPhoto,
                            boolean allowCopyLink, boolean allowCopyLinkPm) {
        this(context, chatActivity, chatActivity != null ? chatActivity.getResourceProvider() : null, messageObject, allowReply, allowReplyPm, allowEdit, allowDelete, allowForward, allowCopy, allowCopyPhoto, allowCopyLink, allowCopyLinkPm);
    }
